...
if [ "$self_fpath" = "$exec_fpath" ]; then
  case "$1" in
    ...
    *)
      ...
      echo "  aamf - Adde auto/manual to file <FILEPATH>"
      echo "  aamd - Adde auto/manual to dir <DIRPATH>"
      echo "  aamif - Adde auto/manual to /etc/network/intefaces"
      echo "  aamid - Adde auto/manual to /etc/network/intefaces.d/*.cfg"
